...
# dat_files=glob.glob('myo1.dat') #Get list of all .dat files in the current folder
...
recordname='02012.dat'
# print(recordname[:-4])
recordname_new=recordname.split('.')[0] #Extracting just the filename part (will differ from database to database)
